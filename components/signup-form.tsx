...
import { signInWithDiscord, signInWithGitHub, signInWithGoogle, signUpAction } from "@/app/actions"
import { useSearchParams } from 'next/navigation'
import { FormMessage } from "@/components/form-message"
import { motion, HTMLMotionProps } from "framer-motion"

import { signUpFormSchema, type SignUpFormSchema } from "@/components/signupformschema"
...
interface SignUpFormProps extends HTMLMotionProps<"div"> {
   className?: string
}
...
export function SignUpForm({
   ...
   return (
      <motion.div 
         initial="hidden"
         animate="visible"
         className={ny("flex flex-col gap-6", className)} 
         {...props}
      >
         <Card className="overflow-hidden">
            <CardContent className="grid p-0 md:grid-cols-2 z-10">
               <Form {...form}>
                           ...
                           <FormField
                             ...
                             render={({ field }) => (
                               <FormItem>
                                 ...
                                 <FormFieldMessage className="text-sm" />
                               </FormItem>
                             )}
                           />
                        </motion.div>
