...
const AdvancedEditor = ({ blockId: initialBlockId, initialContent }: AdvancedEditorProps) => {
  ...
  return (
    <div className="relative w-full max-w-screen-lg mx-auto h-full flex flex-col">
      ...
      <div className="flex-1 overflow-hidden">
        <EditorRoot>
          <EditorContent
            ...
            className="relative p-4 w-full max-w-screen-lg bg-background sm:rounded-lg sm:shadow-lg overflow-y-auto h-[90vh]"
            editorProps={{
              handleDOMEvents: {
